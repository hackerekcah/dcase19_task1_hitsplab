...
class Dcase19TaskbData:
    ...
    def __init__(self):
        ...
        self.config = config
        self.dev_path = config['dcase19_taskb']['dev_path']
        ...
        self.train_path = os.path.join(self.dev_path, 'evaluation_setup/fold1_train.csv')
        self.test_path = os.path.join(self.dev_path, 'evaluation_setup/fold1_evaluate.csv')
    ...
    def extract_fea_for_datagroup(self, data_group, mode='train'):
        ...
        for i, line in tqdm(enumerate(fp)):
            if i == 0:
                # skip head line, which is : filename	scene_label
                continue
...
if __name__ == '__main__':
    ...
    data_manager = Dcase19TaskbData()
    data_manager.create_devh5()
    data_manager.create_dev_matrix()
    data_manager.create_dev_matrix_fnames()
    data, label = data_manager.load_dev('train', devices='a')
    # data_manager.show_spec_by_name(wav_name='metro-vienna-228-6855-a.wav')
    # data_manager.show_spec_by_name(wav_name='park-london-243-7250-a.wav')
    # data_manager.show_spec_by_name(wav_name='airport-paris-206-6276-a.wav')
