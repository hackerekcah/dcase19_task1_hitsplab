import argparse
import os
from data_loader.lb_loader import Dev_Medfilter_Loader
...
def run(args):
    ...
    loader = Dev_Medfilter_Loader(is_divide_variance=args.is_divide_variance)
    ...
    val_hist = dict()
    for d in test_list:
        val_hist[d] = History('val/{}'.format(d))
